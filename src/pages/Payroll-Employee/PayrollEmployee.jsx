...
const PayrollEmployee = () => {
  ...
  const {
    ...
    isFetching,
    isLoading,
  } = useGetPayRollRecordsforAUserQuery(userDetails.user_id);
    ...
    <div class="payroll-container">
      <table>
        ...
        <tr>
          <th>Date of Birth</th>
          <td>
            {formattedDOB.date}/{formattedDOB.month}/{formattedDOB.year}
          </td>
      ...
      <table>
        ...
        <tr>
          <td>Gross Salary</td>
          <td>
            {payrollEmployeeData ? payrollEmployeeData[0].gross_salary : "-"}
          </td>
          <td>NSSF</td>
          <td>-</td>
        </tr>
        <tr>
          <td>Overtime</td>
          <td>
            {payrollEmployeeData ? payrollEmployeeData[0].total_overtime : "-"}
          </td>
          <td>Income tax</td>
          <td>-</td>
        </tr>
