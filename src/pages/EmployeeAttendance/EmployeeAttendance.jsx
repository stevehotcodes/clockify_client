...
const EmployeeAttendance = () => {
  ...
  const handleClockIn = async (user) => {
    ...
    const conventionalClockOutTime = new Date(
      userDetails.out_time,
    ).getUTCHours();
  ...
  const handleClockOut = async (e) => {
    try {
      const confirmed = window.confirm(
        "Do you wish to clock out today. Kindly once you clock out  ",
      );
      if (confirmed) {
        ...
        <div className="search-add-new-btn">
          ...
          <div className="button-wrapper">
            <button
              ...
              onClick={() => handleClockIn(userDetails)}
            >
              Clock In
            </button>
            <button className="add-new-btn" onClick={handleClockOut}>
              Clock Out
            </button>
          </div>
        </div>
