...
} from "../../features/EmployeeListing/EmployeeListing";
...
const AdminDashboard = () => {
  ...
  const { data: attendanceStatistics } =
    useGetAttendanceReportStatisticsQuery();

  console.log(attendanceStatistics);
  const [attendanceStats, setAttendanceStatistics] =
