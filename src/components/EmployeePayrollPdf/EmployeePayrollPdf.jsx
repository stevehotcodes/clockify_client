...
const EmployeePayrollPdf   =({ userDetails, payrollEmployeeData, datefullYear })=> {
        ...
        <View style={styles.section}>
          ...
          <View style={styles.table}>
            <View style={styles.row}>
              ...
              <Text style={styles.cellValue}>{userDetails.identification_number}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.cellLabel}>Name:</Text>
              <Text style={styles.cellValue}>{`${userDetails.firstname} ${userDetails.lastname}`}</Text>
            </View>
            <View style={styles.row}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.cellValue}>{`${formattedDOB.date}/${formattedDOB.month}/${formattedDOB.year}`}</Text>
            </View>
            <View style={styles.row}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.cellValue}>{userDetails.schedule_description }</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.cellLabel}>Position:</Text>
              <Text style={styles.cellValue}>{userDetails.position_description}</Text>
            </View>
          </View>
          ...
          <View style={styles.table}>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.cellValue}>{payrollEmployeeData ? payrollEmployeeData[0].gross_salary : '-'}</Text>
              <Text style={styles.cellLabel}>NSSF</Text>
              <Text style={styles.cellValue}>-</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.cellLabel}>Overtime</Text>
              <Text style={styles.cellValue}>{payrollEmployeeData ? payrollEmployeeData[0].total_overtime : '-'}</Text>
            ...
            <View style={styles.row}>
              ...
              <Text style={styles.cellValue}>{payrollEmployeeData ? payrollEmployeeData[0].total_cash_advances : '-'}</Text>
            </View>
            <View style={styles.row}>
              <Text style={styles.cellLabel}>Gross Earnings</Text>
              <Text style={styles.cellValue}>Ksh: {payrollEmployeeData ? payrollEmployeeData[0].gross_salary + payrollEmployeeData[0].total_overtime : '-'}</Text>
              <Text style={styles.cellLabel}>Gross Deductions</Text>
              <Text style={styles.cellValue}>Ksh.{payrollEmployeeData ? payrollEmployeeData[0].total_deductions : '-'}</Text>
            </View>
            <View style={styles.row}>
                   <Text style={styles.label}></Text>
                    <Text style={styles.value}>NET PAY:</Text>
                    <Text style={styles.value}>{payrollEmployeeData ? payrollEmployeeData[0].net_pay : '-'}</Text>
            </View>
        </View>
        </View>
   </Page>
